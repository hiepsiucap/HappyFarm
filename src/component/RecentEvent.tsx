...
interface Column {
  id: "name" | "dateRegister" | "project" | "totalpeople" | "totalprice";
  label: string;
  minWidth?: number;
  align?: "right";
...
const columns: readonly Column[] = [
  ...
  },
  {
    ...
    align: "right",
    format: (value: number) => {
      if (value === 0) return "Lượt thành viên";
...
function createData(
  ...
  return { name, dateRegister, project, totalpeople, totalprice };
}

const rows = [
  createData("Nguyễn Hồng Hiệp", "Workshop làm bánh dâu tây", 3, 0),
  createData("Nguyễn Hồng Hiệp", "Workshop làm bánh dâu tây", 3, 0),
  createData("Nguyễn Hồng Hiệp", "Workshop làm bánh dâu tây", 3, 0),
  createData("Nguyễn Hồng Hiệp", "Workshop làm bánh dâu tây", 3, 0),
  createData("Nguyễn Hồng Hiệp", "Workshop làm bánh dâu tây", 3, 120000),
];
...
export default function RecentSubEvent() {
